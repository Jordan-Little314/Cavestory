	...
	_y(posY)
{
	...
	this->_boundingBox = Rectangle(this->_x, this->_y, width * gloabals::SPRITE_SCALE, 
		height * gloabals::SPRITE_SCALE);
...
{
	SDL_Rect destinationRectangle = { x, y, this->_sourceRect.w * gloabals::SPRITE_SCALE, 
		this->_sourceRect.h * gloabals::SPRITE_SCALE };
...
void Sprite::update()
{
	this->_boundingBox = Rectangle(this->_x, this->_y,
		this->_sourceRect.w * gloabals::SPRITE_SCALE, this->_sourceRect.h * gloabals::SPRITE_SCALE);
}
