...
Tile::Tile(SDL_Texture* tileset, Vector2 size, Vector2 tilesetPosition, Vector2 position) :
	...
	_position(Vector2(position.x * gloabals::SPRITE_SCALE, position.y * gloabals::SPRITE_SCALE))
{}
...
{
	SDL_Rect destRect = { this->_position.x, this->_position.y, this->_size.x * gloabals::SPRITE_SCALE,
						this->_size.y * gloabals::SPRITE_SCALE };
